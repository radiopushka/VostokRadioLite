...
- **Configuration**: the audiocfg file has all the configuration options available, pass it to vtkradio: ```vtkradio ./audiocfg``` and it will show you the active configuration. It is optimized for the PI 3 A+ and above as well as most professional FM transmitters.
